<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="可预约人数" prop="keyuyuerenshu">
          <el-input v-model="ruleForm.keyuyuerenshu" 
              placeholder="可预约人数" clearable  :readonly="ro.keyuyuerenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="可预约人数" prop="keyuyuerenshu">
              <el-input v-model="ruleForm.keyuyuerenshu" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="工作人员" prop="gongzuorenyuan">
          <el-input v-model="ruleForm.gongzuorenyuan" 
              placeholder="工作人员" clearable  :readonly="ro.gongzuorenyuan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="工作人员" prop="gongzuorenyuan">
              <el-input v-model="ruleForm.gongzuorenyuan" 
                placeholder="工作人员" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `yiliaojigou/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yiliaojigouCrossAddOrUpdateFlag = false;
                  this.parent.search();
