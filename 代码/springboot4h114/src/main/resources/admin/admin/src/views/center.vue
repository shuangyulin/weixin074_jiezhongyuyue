  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='yonghu'"  label="监护人姓名" prop="jianhurenxingming">
          <el-input v-model="ruleForm.jianhurenxingming"               placeholder="监护人姓名" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='yonghu'"  label="儿童姓名" prop="ertongxingming">
          <el-input v-model="ruleForm.ertongxingming"               placeholder="儿童姓名" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='yonghu'"  label="接种编号" prop="jiezhongbianhao">
          <el-input v-model="ruleForm.jiezhongbianhao"               placeholder="接种编号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
